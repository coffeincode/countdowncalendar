...
$GLOBALS['TL_MODELS']['tl_countdowncalendar']  = 'CoffeinCode\CountdownCalendar\CountdownCalendarModel';
$GLOBALS['TL_MODELS']['tl_countdown_door']     ='CoffeinCode\CountdownCalendar\CountdownDoorModel';
